...
Установите MySQL Server, MySQL Workbench и MySQL Shell с официального сайта MySQL.
В процессе установки задайте пароль для пользователя root и запомните его.
